...
import { ConditionMenuPanel, ConditionMenuMobile } from "@/components/ConditionMenu";
            ...
            <nav className="hidden xl:block">
              <ul className="flex items-center gap-6 text-base font-medium text-gray-800">
                <li className="relative group">
                  ...
                  {/* Condition menu — INDIVIDUAL / RELATIONSHIP / SEXUAL & INTIMACY,
                      driven entirely by published rows in counselling_services. */}
                  {isFindCareOpen && (
                    <ConditionMenuPanel onNavigate={() => setIsFindCareOpen(false)} />
                  )}
                </li>
            ...
            <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4 overscroll-contain" style={{ WebkitOverflowScrolling: 'touch' }}>
              ...
              <div className="space-y-2">
                ...
                <div className="border-b border-gray-100">
                  ...
                  {/* Condition menu (mobile) — same CMS-driven three groups. */}
                  {isMobileFindCareOpen && (
                    <ConditionMenuMobile onNavigate={() => { setIsMobileFindCareOpen(false); setIsMobileMenuOpen(false); }} />
                  )}
                </div>
